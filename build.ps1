...
Param(
    ...
    [string]$Target,
    [string]$CoverityViewId,
    [string]$CoverityProjectId,
...
if ($CoverityViewId) { $cakeArguments += "-coverityviewid=$CoverityViewId" }
if ($CoverityProjectId) { $cakeArguments += "-coverityprojectid=$CoverityProjectId" }
